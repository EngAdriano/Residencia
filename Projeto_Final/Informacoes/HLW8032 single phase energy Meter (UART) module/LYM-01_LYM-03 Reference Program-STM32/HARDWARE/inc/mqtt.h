...
//{
//  "ProductKey": "a1H1IlvigrN",
//  "DeviceName": "S001",
//  "DeviceSecret": "eEIqo2rCXCfaQgZSh4go97wqyHDBRrkb"
//}

#define  PRODUCTKEY           "a1H1IlvigrN"                                        //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                                   //产品ID长度
#define  DEVICENAME           "S001"                                               //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "eEIqo2rCXCfaQgZSh4go97wqyHDBRrkb"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a1H1IlvigrN/S001/thing/service/property/set"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/sys/a1H1IlvigrN/S001/thing/event/property/post"    //需要发布的主题  
